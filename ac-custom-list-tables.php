<?php
/**
 * Plugin Name:       Admin Columns - Custom List Tables Cookbook
 * Plugin URI:        https://www.admincolumns.com/
 * Description:       A collection of annotated code examples that demonstrate how to register custom Data Sources for Admin Columns. Enable examples in bootstrap.php.
 * Version:           1.0.0
 ...
 *   3. Visit the "Cookbook" menu in the WordPress admin to see the resulting tables.
 */
